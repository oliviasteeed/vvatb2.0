...
<div class='outer-content-container'>
    <div class='inner-content-container'>
        ...
        <div class="image-wrapper">
            <!-- ine -->
            <img src="../media/img/ine/tracklist.png" id="ine-tracklist"/>

            <img src="../media/img/ine/title.png" id="ine-title">

            <img src="../media/img/ine/eyeopen.png" id="ine-eyeopen"/>

            <img src="../media/img/ine/eyeclosed.png" id="ine-eyeclosed"/>

            <!-- aa -->
            <img src="../media/img/aa/title.png" id="aa-title"/>

            <img src="../media/img/aa/tracklist.png" id="aa-tracklist"/>

            <img src="../media/img/aa/heart.png" id="aa-heart"/>

            <img src="../media/img/aa/lightning.png" id="aa-lightning"/>

            <!-- tna -->
             <img src="../media/img/tna/title.png" id="tna-title"/>

             <img src="../media/img/tna/tracklist.png" id="tna-tracklist"/>

             <img src="../media/img/tna/dude.png" id="tna-dude"/>

             <img src="../media/img/tna/kiki.png" id="tna-kiki"/>


            <!-- album covers -->
            <img src="../media/img/ine/cover.png" class="flip-image" id="ine" onclick="window.location.href='album.php?project=itsneverenough'"/>

            <img src="../media/img/aa/cover.png" class="flip-image" id="aa" onclick="window.location.href='album.php?project=anxiousavoidant'"/>

            <img src="../media/img/tna/cover.png" class="flip-image" id="tna" onclick="window.location.href='album.php?project=thenextalbum'"/>
...
<!-- photo flip on hover -->
 <div class='outer-flipbook-container'>
        <p>hover to view some pics of the band <span class='a-bracket'>(<span>and the viavia<span class='a-bracket'>)<span></p>
